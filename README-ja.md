*[English](README.md) ∙ [日本語](README-ja.md) ∙ [简体中文](README-zh-Hans.md) ∙ [繁體中文](README-zh-TW.md) | [العَرَبِيَّة‎](https://github.com/donnemartin/system-design-primer/issues/170) ∙ [বাংলা](https://github.com/接準備用にフォークしたものです。重要なメモを追記していく予定です。

<!-- 個人メ重点的に学ぶ -->
<!--ャッシュ戦略とロードバランシングも優先的に復習する -->

計を学ぶことは、より良いエンジニアになることに資するでしょう。

システム設計はとても広ます。システム設計原理については **インターネット上には膨大な量の文献が散らばっています。**ジトリは大規模システム構築に必要な知識を学ぶことができる **文献リストを体系的にまとめたもの** です。
...
* [Coding deck](https://github.com/donnemartin/interactive-c
